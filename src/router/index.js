...
export const routes = [
...

  {
    ...
    meta: {
      ...
      description:
        'Всички проекти: PPF защитно фолио, затъмняване на стъкла и детайлинг.',
    },
  },
...

  {
    ...
    meta: {
      title: `Портфолио | Проект | ${BRAND}`,
      description:
        'Подробности за индивидуален проект. Детайлинг, облепяне с защитно фолио и затъмняване на стъкла. Гарантиран премиум резултат.',
    },
  },
