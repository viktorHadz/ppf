...
export const routes = [
...

  {
    ...
    meta: {
      title: `За нас | ${BRAND}`,
      description: 'Екип и подход: прецизен монтаж, внимание към детайла и премиум материали за защита и визия на автомобила.',
    },
  },

  {
    ...
    meta: {
      ...
      description: 'Изпратете запитване за PPF защитно фолио, затъмняване на стъкла, детайлинг или застраховки в София. Отговаряме бързо.',
    },
  },
  ...
  },
  {
    ...
    meta: {
      ...
      description: 'Екстериорен и интериорен детайлинг в София: деконтаминация, полиране и защитни покрития за премиум вид и поддръжка.',
    },
  },
  {
    path: '/insurance',
    ...
    meta: {
      ...
      description: 'Съдействие при избор на застраховка и консултация за защита на автомобила. Бърза комуникация и ясни условия.',
    },
  },

  {
    ...
    meta: {
      ...
      description: 'Професионално затъмняване на стъкла в София с UV защита и комфорт. Прецизен монтаж и дълготраен резултат.',
    },
  },
